...
mape1 = -cv_scores1.mean()  # cv_scores will be negative because of the 'neg_mean_absolute_error' scoring
...
mape3 = -cv_scores3.mean()

print(f"Cross-validated MAPE for model 1: {mape1} %")
print(f"Cross-validated MAPE for model 2: {mape2} %")
print(f"Cross-validated MAPE for model 3: {mape3} %")

best_mape = min([mape1, mape2, mape3])
if best_mape == mape1:
    best_model = rf1
elif best_mape == mape2:
    best_model = rf2
else:
    best_model = rf3
